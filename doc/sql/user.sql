...
CREATE TABLE USER_INFO(
        ...
        AGE int COMMENT '年龄',
        INDUSTRY VARCHAR(16) COMMENT '行业',
...
ALTER TABLE USER_INFO ADD EXPECTED_JOB VARCHAR(16),ADD EXPECTED_BASE VARCHAR(16),ADD ACCEPTED_OUT CHAR(1),ADD CHANNEL CHAR(1);